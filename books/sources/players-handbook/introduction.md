...
## [](https://www.dndbeyond.com/sources/phb/introduction#WorldsofAdventure)Worlds of Adventure
...
## [](https://www.dndbeyond.com/sources/phb/introduction#UsingThisBook)Using This Book

The _Player’s Handbook_ is divided into three parts.

**Part 1** (chapters 1–6) is about creating a character, providing the rules and guidance you need to make the character you’ll play in the game. It includes information on the various [races](https://www.dndbeyond.com/sources/phb/races), [classes](https://www.dndbeyond.com/sources/phb/classes#ClassesSummary), [backgrounds](https://www.dndbeyond.com/sources/phb/personality-and-background#Backgrounds), [equipment](https://www.dndbeyond.com/sources/phb/equipment), and other [customization options](https://www.dndbeyond.com/sources/phb/customization-options) that you can choose from. Many of the rules in part 1 rely on material in parts 2 and 3. If you come across a game concept in part 1 that you don’t understand, consult the book’s index.

**Part 2** (chapters 7–9) details the rules of how to play the game, beyond the basics described in this introduction. That part covers the kinds of die rolls you make to determine success or failure at the tasks your character attempts, and describes the three broad categories of activity in the game: [exploration](https://www.dndbeyond.com/sources/phb/adventuring), [interaction](https://www.dndbeyond.com/sources/phb/adventuring#SocialInteraction), and [combat](https://www.dndbeyond.com/sources/phb/combat).

**Part 3** (chapters 10–11) is all about magic. It covers the nature of magic in the worlds of D&D, the rules for [spellcasting](https://www.dndbeyond.com/sources/phb/spellcasting), and the huge variety of [spells](https://www.dndbeyond.com/sources/phb/spells) available to magic-using characters (and monsters) in the game.

## [](https://www.dndbeyond.com/sources/phb/introduction#HowtoPlay)How to Play
...
### [](https://www.dndbeyond.com/sources/phb/introduction#GameDice)Game Dice
...
The target number for an ability check or a saving throw is called a **Difficulty Class** (DC). The target number for an attack roll is called an [Armor Class](https://www.dndbeyond.com/compendium/rules/basic-rules/step-by-step-characters#ArmorClass) (AC).

This simple rule governs the resolution of most tasks in D&D play. Chapter 7, "[Using Ability Scores](https://www.dndbeyond.com/sources/phb/using-ability-scores)" provides more detailed rules for using the d20 in the game.

### [](https://www.dndbeyond.com/sources/phb/introduction#AdvantageandDisadvantage)Advantage and Disadvantage
...
More detailed rules for advantage and disadvantage are presented in [chapter 7](https://www.dndbeyond.com/sources/phb/using-ability-scores).

### [](https://www.dndbeyond.com/sources/phb/introduction#SpecificBeatsGeneral)Specific Beats General
...
### [](https://www.dndbeyond.com/sources/phb/introduction#RoundDown)Round Down

There’s one more general rule you need to know at the outset. Whenever you divide a number in the game, round down if you end up with a fraction, even if the fraction is one-half or greater.

## [](https://www.dndbeyond.com/sources/phb/introduction#Adventures)Adventures
...
### [](https://www.dndbeyond.com/sources/phb/introduction#TheThreePillarsofAdventure)The Three Pillars of Adventure
...
The rules in part 2 (especially "[Using Ability Scores](https://www.dndbeyond.com/sources/phb/using-ability-scores)" and "[Adventuring](https://www.dndbeyond.com/sources/phb/adventuring)") support exploration and social interaction, as do many class features in "[Classes](https://www.dndbeyond.com/sources/phb/classes)" and personality traits in "[Personality and Background](https://www.dndbeyond.com/sources/phb/personality-and-background)."

**Combat,** the focus of [chapter 9](https://www.dndbeyond.com/sources/phb/combat), involves characters and other creatures swinging weapons, casting spells, maneuvering for position, and so on—all in an effort to defeat their opponents, whether that means killing every enemy, taking captives, or forcing a rout. Combat is the most structured element of a D&D session, with creatures taking turns to make sure that everyone gets a chance to act. Even in the context of a pitched battle, there’s still plenty of opportunity for adventurers to attempt wacky stunts like surfing down a flight of stairs on a shield, to examine the environment (perhaps by pulling a mysterious lever), and to interact with other creatures, including allies, enemies, and neutral parties.

### [](https://www.dndbeyond.com/sources/phb/introduction#TheWondersofMagic)The Wonders of Magic

Few D&D adventures end without something magical happening. Whether helpful or harmful, magic appears frequently in the life of an adventurer, and it is the focus of [part 3](https://www.dndbeyond.com/sources/phb/spellcasting).
...
[![](https://www.dndbeyond.com/attachments/thumbnails/6/553/389/202/dice_2.png)](https://www.dndbeyond.com/attachments/6/553/dice_2.png)