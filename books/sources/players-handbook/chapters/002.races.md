...
Characters of most races are Medium, a size category including creatures that are roughly 4 to 8 feet tall. Members of a few races are Small (between 2 and 4 feet tall), which means that certain rules of the game affect them differently. The most important of these rules is that Small characters have trouble wielding heavy weapons, as explained in [[005.equipment|Chapter 5: Equipment]].

#### Speed

Your speed determines how far you can move when traveling (“[[008.adventuring|Chapter 8: Adventuring]]”) and fighting ("[[009.combat|Chapter 9: Combat]]").

#### Languages

Your character can speak, read, and write certain languages. [[004.personality-and-background|Chapter 4: Personality and Background]] lists the most common languages of the D&D multiverse.
